...
class Status(commands.Cog):
    ...
    async def botinfo(self,ctx):
        ...
        embed.add_field(name="Current Version", value=f"2.0.5", inline=False)
    ...
    async def invite(self,ctx):
        ...
        embed.add_field(name = 'Oasis Bot Invite',value = "[Bot Invite](https://discord.com/api/oauth2/authorize?client_id=830817370762248242&permissions=8&scope=bot%20applications.commands)")
        embed.add_field(name = 'Serenity Bot Invite',value = '[Bot Invite](https://discord.com/api/oauth2/authorize?client_id=752335987761217576&permissions=8&scope=applications.commands%20bot)',inline = False)
