...
class Status(commands.Cog):
    ...
    async def rules(self,ctx):
        ...
        embed.add_field(name = "3. Harrassment/Slurs",value = "You shall not use this bot to harass any other user for any reason, or to send slurs through any bot feature.",inline = False)
        embed.add_field(name = "4. Language",value = "Any excessive abusive language advertised through the bot is strictly prohibited. This includes, but is not limited to, advertisement or swears.",inline = False)
        ...
        embed.add_field(name = "6. Discord TOS",value = "You are required to follow all terms outlined in the Discord Terms of Serivce while using this bot.",inline = False)
